...
public class ComodoUtil {
    public static String ID = "74d8f5a2-1d85-11ee-be56-0242ac120002", ID_FALSE = "24d8f5a2-1d85-11ee-be56-0242ac120002",  NOME = "SALA", USUARIO = "84d8f5a2-1d85-11ee-be56-0242ac120002";
    ...
    public static ComodoPutDto factoryPutDto(String nome) {
        return ComodoPutDto.builder().id(UUID.fromString(ID)).nome(nome).build();
    }

...
public class EnderecoController {
    ...
    @PostMapping("/save")
    public ResponseEntity<EnderecoModel> save(@RequestBody @Valid EnderecoDto endereco) {
    ...
    public ResponseEntity<List<EnderecoModel>> listAll() {
        return ResponseEntity.status(HttpStatus.OK).body(enderecoService.listAll());
    }
}

...
### TASKS
- DOCUMENTACAO:
  - O TIPO DE DATA AGORA E LOCALDATETIME
	- DISPOSITIVO TEVE ATRIBUTOS ALTERADOS
	- ADMIN, SUP E USUARIO -> USUARIO(A TIPAGEM FICOU EM UM ENUM)
	- REPRESENTAR ENUMS SOMENTE NO UML
    
- TESTE:
  - ESTUDAR TODA A APLICACAO;
  - COMPREENDER A ESTRUTURA DO TESTE E BUSCAR REPLICA-LO COM LOGICA;
  - ATENCAO AS ANOTACOES(PRESENTES NOS DTO`S);
  - VIU ALGUMA VULNERABILIDADE, RELATA O PONTO E O CENARIO;
  - ESTRUTURA LEGIVEL, SIGA O PADRAO E AS BOAS PRATICAS;
  - ************** ENTENDA O QUE ESTA ACONTENCENDO, ANTES DE FAZER. TESTAR ENVOLVE PENSAR NO IMPENSAVEL **************
